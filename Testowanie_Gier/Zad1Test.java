...
import MockitoExtension;

@ExtendWith(MockitoExtension.class)
class Zad1Test {
    @Test
    public void Testujemy(){
        Car car = mock(Car.class); // tworzymy mocka
        when(car.findMileageBetweenYears(2010L, 2012L)).thenReturn(100L);
        assertEquals(100L, car.findMileageBetweenYears(2010L, 2012L));
    }
    /* 
